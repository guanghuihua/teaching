...
本册按方法分类选取本地题库中的2016--2025年高考真题。每题均保留年份、卷别和题号，题干、答案和解析以所列题源的 \texttt{questions.json} 为核对依据。

本册不把模型自动生成的示意图作为课堂图形使用。需要图形信息时，应先查阅所列原卷；教师自绘图必须逐一核对曲线方程、点的归属、直线关系及长度或角度条件。建议学生先独立完成，再使用答案版复盘方法选择与运算过程。
...
\begin{center}
{\small\textit{图形信息以题设及所列原卷为准；本讲义不保留未经题设反算验证的自动示意图。}}
\end{center}
\begin{solution}
