...
\begin{tikzpicture}[x=1.15cm,y=1.15cm]
  \draw[->] (-1.7,0)--(1.8,0) node[right] {$x$}; \draw[->] (0,-1.2)--(0,1.3) node[above] {$y$};
  \draw[curve] (0,0) ellipse ({sqrt(2)} and 1);
  \draw[construction] (0.2,0.707)--(0.2,0)--(0.2,1);
  \foreach \p/\lab/\pos in {(0.2,0.707)/M/right,(0.2,0)/N/below,(0.2,1)/P/right,(-1,0)/F/below}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.65cm,y=.65cm]
  \draw[->] (-5,0)--(4,0) node[right] {$x$}; \draw[->] (0,-4)--(0,3) node[above] {$y$};
  \draw[curve] (-1,0) circle (4);
  \draw[construction] (1,0)--(2.646,1.646) node[right] {$l$};
  \draw[construction] (-1,0)--(2.646,1.646) (-1,0)--(-2.646,-3.646);
  \draw[construction] (1,0)--(-.756,-1.134);
  \foreach \p/\lab/\pos in {(-1,0)/A/below,(1,0)/B/below,(2.646,1.646)/C/right,(-2.646,-3.646)/D/below,(-.756,-1.134)/E/above}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.5cm,y=.5cm]
  \draw[->] (-4,0)--(6,0) node[right] {$x$}; \draw[->] (0,-4)--(0,5) node[above] {$y$};
  \draw[auxiliary] (-2,-3.5)--(-2,4.5) node[above] {$x=-2$};
  \draw[auxiliary] (-3,-3.5)--(-3,4.5) node[above] {$x=-3$};
  \draw[curve,domain=-5.5:5.5,smooth] plot ({\x*\x/8},{\x});
  \draw[construction] (2,0)--(2,4);
  \foreach \p/\lab/\pos in {(2,0)/F/below,(2,4)/M/right}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.7cm,y=.7cm]
  \draw[->] (-2,0)--(4,0) node[right] {$x$}; \draw[->] (0,-1)--(0,3) node[above] {$y$};
  \draw[auxiliary] (-1,-.8)--(-1,2.8) node[above] {$x=-1$};
  \draw[curve,domain=-3.2:3.2,smooth] plot ({\x*\x/4},{\x});
  \draw[construction] (1,2)--(3,0) (1,0)--(1,2);
  \foreach \p/\lab/\pos in {(1,0)/F/below,(1,2)/A/left,(3,0)/B/below}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.7cm,y=.7cm]
  ...
  \draw[auxiliary] (-1,-.8)--(-1,4.7) node[above] {$x=-1$};
  \draw[curve,domain=-4.3:4.3,smooth] plot ({\x*\x/4},{\x});
  \draw[construction] (-1,4)--(1,0)--(4,4)--(-1,4);
  \foreach \p/\lab/\pos in {(1,0)/F/below,(-1,4)/B/left,(4,4)/A/right}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{center}
\begin{tikzpicture}[x=.7cm,y=.7cm]
  \draw[->] (-3,0)--(3,0) node[right] {$x$}; \draw[->] (0,-2)--(0,3) node[above] {$y$};
  \draw[curve] (0,0) ellipse (2 and 1);
  \draw[construction] (-2,0)--(1,0.866) (-2,0)--(-1,0.866);
  \foreach \p/\lab/\pos in {(-2,0)/A/below,(1,.866)/P/above,(-1,.866)/Q/above}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.72cm,y=.72cm]
  \draw[->] (-3,0)--(3,0) node[right] {$x$}; \draw[->] (0,-2)--(0,2) node[above] {$y$};
  \draw[curve] (0,0) ellipse (2 and {sqrt(2)});
  \draw[construction] (-1.155,-1.155)--(1.155,1.155) (-1.155,-1.155)--(1.925,.385) (1.155,1.155)--(1.925,.385);
  \draw[auxiliary] (1.155,1.155)--(1.155,0);
  \foreach \p/\lab/\pos in {(1.155,1.155)/P/above,(-1.155,-1.155)/Q/below,(1.155,0)/E/below,(1.925,.385)/G/right}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.8cm,y=.8cm]
  \draw[->] (-3,0)--(3,0) node[right] {$x$}; \draw[->] (0,-1.5)--(0,2) node[above] {$y$};
  \draw[curve] (0,0) ellipse (2 and 1);
  \draw[construction] (-1.414,.707)--(1.414,-.707) (0,1)--(-1.414,.707) (0,1)--(1.414,-.707) (2,-1)--(-1.414,.707);
  \foreach \p/\lab/\pos in {(0,1)/P_2/above,(-1.414,.707)/A/above,(1.414,-.707)/B/below,(2,-1)/T/right}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.62cm,y=.62cm]
  \draw[->] (-4,0)--(7,0) node[right] {$x$}; \draw[->] (0,-2)--(0,4) node[above] {$y$};
  \draw[curve] (0,0) ellipse (3 and 1);
  \draw[construction] (-3,0)--(6,3)--(0,1) (3,0)--(6,3)--(2.4,-.6) (0,1)--(2.4,-.6);
  \foreach \p/\lab/\pos in {(-3,0)/A/below,(3,0)/B/below,(6,3)/P/right,(0,1)/C/left,(2.4,-.6)/D/below}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.9cm,y=.9cm]
  \draw[->] (-2,0)--(2,0) node[right] {$x$}; \draw[->] (0,-1)--(0,3) node[above] {$y$};
  \draw[curve,domain=-1.8:1.8,smooth] plot ({\x},{\x*\x/2});
  \draw[construction] (0,-.5)--(-1,.5) (0,-.5)--(1,.5) (-1,.5)--(1,.5);
  \draw[auxiliary] (0,.5)--(0,2.5);
  \foreach \p/\lab/\pos in {(0,-.5)/D/below,(-1,.5)/A/above,(1,.5)/B/above,(0,2.5)/E/right}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{center}
\begin{tikzpicture}[x=.8cm,y=.8cm]
  \draw[->] (-1,0)--(3,0) node[right] {$x$}; \draw[->] (0,-3)--(0,3) node[above] {$y$};
  \draw[auxiliary] (-.5,-2.7)--(-.5,2.7) node[above] {$x=-\frac12$};
  \draw[curve,domain=-2.3:2.3,smooth] plot ({\x*\x/2},{\x});
  \draw[construction] (-.5,2)--(2,2) (-.5,-2)--(2,-2) (-.5,2)--(-.5,-2) (2,2)--(2,-2) (2,2)--(-.5,0);
  \foreach \p/\lab/\pos in {(2,2)/A/right,(2,-2)/B/right,(-.5,2)/P/left,(-.5,-2)/Q/left,(-.5,0)/R/left,(.5,0)/F/below}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{center}
\begin{tikzpicture}[x=.65cm,y=.65cm]
  \draw[->] (-1,0)--(4,0) node[right] {$x$}; \draw[->] (0,-3)--(0,3) node[above] {$y$};
  \draw[curve,domain=-2.4:2.4,smooth] plot ({\x*\x/4},{\x});
  \draw[construction] (.333,.667)--(3,-2) (.333,-.667)--(3,2);
  \foreach \p/\lab/\pos in {(1,0)/F/below,(3,2)/A/right,(.333,.667)/B/left,(3,-2)/D/right,(.333,-.667)/E/left}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{center}
\begin{tikzpicture}[x=.65cm,y=.65cm]
  \draw[->] (-2,0)--(4,0) node[right] {$x$}; \draw[->] (0,-4)--(0,4) node[above] {$y$};
  \draw[auxiliary] (-1,-3.6)--(-1,3.6) node[above] {$l$};
  \draw[curve,domain=-3.7:3.7,smooth] plot ({\x*\x/4},{\x});
  \draw[construction] (.333,1.155)--(3,-3.464) (1,0)--(3,-3.464);
  \foreach \p/\lab/\pos in {(1,0)/F/below,(3,-3.464)/M/right,(.333,1.155)/N/left}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.55cm,y=.55cm]
  \draw[->] (-7,0)--(7,0) node[right] {$x$}; \draw[->] (0,-7)--(0,7) node[above] {$y$};
  \draw[curve] (0,0) ellipse (6 and 5.196);
  \draw[curve,domain=-6:6,smooth] plot ({\x*\x/12},{\x});
  \draw[construction] (3,-6)--(3,6);
  \foreach \p/\lab/\pos in {(3,0)/F/below,(3,4.5)/A/right,(3,-4.5)/B/right,(3,6)/C/right,(3,-6)/D/right}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.65cm,y=.65cm]
  \draw[->] (-2,0)--(4,0) node[right] {$x$}; \draw[->] (0,-4)--(0,4) node[above] {$y$};
  \draw[auxiliary] (-1.5,-3.6)--(-1.5,3.6) node[above] {$l$};
  \draw[curve,domain=-4.2:4.2,smooth] plot ({\x*\x/6},{\x});
  \draw[construction] (1.5,-3)--(1.5,3) (-1.5,0)--(1.5,0) (-1.5,3)--(1.5,3);
  \foreach \p/\lab/\pos in {(1.5,0)/F/below,(1.5,3)/A/right,(1.5,-3)/B/right,(-1.5,3)/D/left,(-1.5,0)/E/below}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{tikzpicture}[x=.75cm,y=.75cm]
  \draw[->] (-3,0)--(3,0) node[right] {$x$}; \draw[->] (0,-1.5)--(0,3.2) node[above] {$y$};
  \draw[curve] (0,0) ellipse ({sqrt(5)} and 1);
  \draw[construction] (-2.041,.408)--(.3,2.749) (0,2.449)--(-1.225,0) (-2.041,.408)--(-1.225,0) (0,1)--(2,0);
  \foreach \p/\lab/\pos in {(2,0)/F/below,(0,1)/B/above,(-2.041,.408)/M/above,(0,2.449)/N/right,(-1.225,0)/P/below}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
...
\begin{center}
\begin{tikzpicture}[x=.55cm,y=.55cm]
  \draw[->] (-7,0)--(7,0) node[right] {$x$}; \draw[->] (0,-7.5)--(0,7.5) node[above] {$y$};
  \draw[curve,domain=-7:-2,smooth] plot ({\x},{sqrt(4*(\x*\x-4))});
  \draw[curve,domain=-7:-2,smooth] plot ({\x},{-sqrt(4*(\x*\x-4))});
  \draw[curve,domain=2:7,smooth] plot ({\x},{sqrt(4*(\x*\x-4))});
  \draw[curve,domain=2:7,smooth] plot ({\x},{-sqrt(4*(\x*\x-4))});
  \draw[construction] (-4,-7)--(-4,7) (-4,6.928)--(-1,-3.464) (-4,-6.928)--(-1,-3.464);
  \foreach \p/\lab/\pos in {(-4,6.928)/M/left,(-4,-6.928)/N/left,(-2,0)/A_1/above,(2,0)/A_2/above,(-1,-3.464)/P/right}
    \fill \p circle (1.2pt) node[\pos] {$\lab$};
\end{tikzpicture}
\end{center}
\begin{solution}
