...
这份讲稿对应同目录27页Beamer，研究信息核查至2026年9月11日。正文可直接讲述，操作与备课提示供教师查看。可按自己的口头习惯改词；系统演示中的“这里”“这一步”，要对应课前选好的真实资料。

40分钟路线：课程要求5分钟；AI历史、神经网络入门和两段完整视频17分钟；IMO成绩引入1分钟；NS方程通俗介绍4分钟；Scholar演示12分钟；结束书写1分钟。第19页讲完直接跳第27页。第20—26页是集合题拓展，不计入这40分钟。
...
Scholar的12分钟包含真实操作、对照原文、学生复述或追问，无需持续读稿。到39分钟直接回第19页收尾；集合题通常留到下次课。
...
\section*{第14页　难在哪里：一直算下去，会发生什么}

{\small\noindent 24:15—25:45\par}
...
\section*{第15页　AI参与了什么}

{\small\noindent 25:45—27:00\par}
...
\tip{Library$\to$Open reader$\to$定位预选页面$\to$选中一句话$\to$Explain/Check me或输入课件提示。约3分钟真实操作与原文对照，留1分钟请学生用自己的话复述或提出追问。响应超过30秒，打开课前已有记录并说明这是以前保存的对话。}
...
\tip{Practice \& Prove$\to$Attempt$\to$Save attempt$\to$Request one hint$\to$保存修改$\to$Schedule 1d + 7d reviews$\to$Reports。约4分钟真实操作，留1分钟请学生判断提示是否解决了卡点。到39分钟必须回第19页；只有提前完成，才点集合题。}
