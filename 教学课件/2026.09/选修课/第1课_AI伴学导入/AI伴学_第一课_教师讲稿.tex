...
\section*{第7页　一个“神经元”怎样计算}

{\small\noindent 06:15—07:15\par}
...
\section*{第8页　连成网络，再用例子训练}

{\small\noindent 07:15—08:15\par}
...
\section*{第9页　纪录片《AlphaGo》预告}

{\small\noindent 08:15—10:00（含视频1分30秒）\par}
...
\section*{第10页　Hinton谈自己的研究经历}

{\small\noindent 10:00—20:45（含视频10分27秒）\par}
...
\section*{第11页　今天的AI为什么能和我们对话}

{\small\noindent 20:45—22:00\par}
...
\tip{Practice \& Prove$\to$Attempt$\to$Save attempt$\to$Request one hint$\to$保存修改$\to$Schedule 1d + 7d reviews$\to$Reports。用约2分钟操作。到39分钟必须回第21页；只有前面明显提前结束，才点集合题。}
