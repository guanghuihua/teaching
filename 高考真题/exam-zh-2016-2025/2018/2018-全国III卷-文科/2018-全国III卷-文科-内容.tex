...
\begin{center}
  \includegraphics[width=.38\linewidth]{question-9-2.jpg}
\end{center}
\begin{choices}
  \item A
  \item B
...
\section*{三、解答题}
共 70 分。解答应写出文字说明、证明过程或演算步骤。第 17～21 题为必考题，每个试题考生都必须作答。第 22、23 题为选考题，考生根据要求作答。（一）必考题：共 60 分。
...
\begin{center}
  \includegraphics[width=.38\linewidth]{question-18-2.jpg}
\end{center}
\begin{solution}
...
\begin{center}
  \includegraphics[width=.38\linewidth]{question-19-2.jpg}
\end{center}
\begin{solution}
...
\begin{center}
  \includegraphics[width=.38\linewidth]{question-23-2.jpg}
\end{center}
\begin{solution}
