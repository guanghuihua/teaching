...
\begin{center}
  {\zihao{3}\bfseries 高中数学一轮复习专题检测}\\[4pt]
  {\zihao{4}\bfseries 数列的通项与求和}
\end{center}

\noindent\textbf{说明：}本试卷满分 100 分，建议用时 90 分钟。所有题目均由文件夹内照片中的完整题面整理、校订或等价改编。

\section{单项选择题：本题共 5 小题，每小题 5 分，共 25 分。每小题只有一项符合题目要求。}
...
\section{多项选择题：本题共 2 小题，每小题 6 分，共 12 分。全部选对得 6 分，部分选对得部分分，有选错得 0 分。}
...
\section{解答题：本题共 4 小题，每小题 12 分，共 48 分。解答应写出必要的文字说明、证明过程或演算步骤。}
